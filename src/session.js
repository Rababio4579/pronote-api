...
const reports = require('./fetch/report');
const { discussions, newDiscussion, recipients, seeDiscussion } = require('./fetch/discussions')
...
const REQUESTS = {
    ...
    infos, homeworks, menu, files, reports, newDiscussion, seeDiscussion,
